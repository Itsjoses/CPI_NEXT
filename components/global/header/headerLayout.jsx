...
export default function HeaderLayout({children}) {
  ...
  return (
    <SecondaryColor className='w-screen h-screen flex relative'>
        ...
        <div className={`ease-in-out duration-300 ${toggleDesktop ? 'lg:ml-60' : 'lg:ml-20'} ml-0 w-full h-full box-border flex flex-col`}>
